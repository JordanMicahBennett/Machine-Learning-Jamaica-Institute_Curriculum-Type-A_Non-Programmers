...
3. Try to construct a basic artificial neural network from scratch, without the usage of any machine learning libraries.
...
2. Write a Recurrent Neural Neural Network (using any ML libraries like Tensorflow), based on video above.
